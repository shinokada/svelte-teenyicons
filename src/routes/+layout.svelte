...
<MetaTags
  {title}
  description="Teenyicon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-teenyicons.vercel.app/',
    title: 'Svelte Teenyicons',
    description: 'Teenyicon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-teenyicons',
        width: 1200,
        height: 630,
        alt: 'Svelte Teenyicons'
      }
    ],
    siteName: 'Svelte Teenyicons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Teenyicons',
    description: 'Teenyicon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-teenyicons',
    imageAlt: 'Svelte Teenyicons'
  }}
/>
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  ...
  <Footer footerType="logo" class="dark:bg-slate-950">
    <div class="sm:flex sm:items-center sm:justify-between">
      <FooterBrand
        href="https://svelte-teenyicons.vercel.app/"
      ...
      >
        <FooterLink class="lg:px-2 lg:mb-0" data-sveltekit-reload>Home</FooterLink>
