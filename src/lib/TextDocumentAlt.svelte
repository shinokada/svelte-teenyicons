...
>
  ...
  {:else}
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M1 1.5C1 0.671573 1.67157 0 2.5 0H10.7071L14 3.29289V13.5C14 14.3284 13.3284 15 12.5 15H2.5C1.67157 15 1 14.3284 1 13.5V1.5ZM4 3.99738H11V4.99738H4V3.99738ZM11 6.99542H4V7.99542H11V6.99542ZM11 10H4V11H11V10Z"
      fill={color}
    />
  {/if}
</svg>
...
@prop export let ariaLabel = 'text document alt';
-->
