...
>
  {#if variation === 'outline'}
    <path d="M0.5 13.5C0.5 14.0523 0.947715 14.5 1.5 14.5C2.05228 14.5 2.5 14.0523 2.5 13.5C2.5 12.9477 2.05228 12.5 1.5 12.5C0.947715 12.5 0.5 12.9477 0.5 13.5Z" stroke="{color}"/> <path d="M14.5 15C14.5 6.99187 8.00813 0.5 0 0.5" stroke="{color}"/> <path d="M0 6.5C4.69442 6.5 8.5 10.3056 8.5 15" stroke="{color}"/> 
  {:else}
