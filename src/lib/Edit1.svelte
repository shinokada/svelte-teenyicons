...
>
  ...
  {:else}
    ...
    <path
      ...
      fill={color}
    /> <path d="M8 15H15V14H8V15Z" fill={color} />
  {/if}
</svg>
...
@prop export let ariaLabel = 'edit 1';
-->
