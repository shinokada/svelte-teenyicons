<script lang="ts">
  ...
  let svgsolid = `<path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 0C11.6421 0 15 3.35786 15 7.5C15 11.6421 11.6421 15 7.5 15C3.35786 15 -2.54447e-06 11.6421 0 7.5C0 3.35786 3.35786 -2.54447e-06 7.5 0ZM3.29297 8.99995L7.50008 4.79285L11.7072 8.99995H3.29297Z" fill="${color}"/> `;
  switch (variation) {
    case "outline":
      svgpath = svgoutline;
      break;
