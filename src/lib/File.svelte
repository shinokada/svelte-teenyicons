<script lang="ts">
	...
	let svgsolid = `<path d="M2.5 0C1.67157 0 1 0.671574 1 1.5V13.5C1 14.3284 1.67157 15 2.5 15H12.5C13.3284 15 14 14.3284 14 13.5V3.29289L10.7071 0H2.5Z" fill="black"/> `;
	switch (variation) {
		case 'outline':
			svgpath = svgoutline;
			break;
