<script lang="ts">
  ...
  export let ariaLabel = 'bed single';
</script>
...
>
  {#if variation === 'outline'}
    <path d="M14.5 4V15M0.5 0V15M0 10.5H15M0 7.5H15M2 5.5H6" stroke={color} />
  {:else}
    <path d="M0 15H1V11H14V15H15V4H14V7H1V0H0V15Z" fill={color} />
    <path d="M6 6H2V5H6V6Z" fill={color} />
  {/if}
</svg>
...
@prop export let ariaLabel = 'bed single';
-->
