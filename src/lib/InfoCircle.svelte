...
>
  ...
  {:else}
    <path fill-rule="evenodd" clip-rule="evenodd" d="M15 7.5C15 11.6421 11.6421 15 7.5 15C3.35786 15 0 11.6421 0 7.5C0 3.35786 3.35787 0 7.5 0C11.6421 0 15 3.35786 15 7.5ZM7 4.99999V3.98999H8V4.99999H7ZM8 6.99999V9.99999H9V11H6V9.99999H7V7.99999H6V6.99999H8Z" fill="{color}"/> 
  {/if}
</svg>
