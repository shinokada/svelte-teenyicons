...
>
  ...
  {:else}
    <path
      d="M7.85355 0.146447C7.65829 -0.0488155 7.34171 -0.0488155 7.14645 0.146447L1 6.29289V13.5C1 14.3284 1.67157 15 2.5 15H12.5C13.3284 15 14 14.3284 14 13.5V6.29289L7.85355 0.146447Z"
      fill={color}
    />
  {/if}
</svg>
...
@prop export let ariaLabel = 'home alt';
-->
