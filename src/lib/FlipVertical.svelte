...
>
  {#if variation === 'outline'}
    ...
    />
  {:else}
    <path d="M7 0V15H8V0H7Z" fill={color} />
    <path
      d="M4.61488 3.01342C4.84056 3.0667 5 3.26816 5 3.50005V11.5C5 11.7762 4.77614 12 4.5 12H0.500001C0.326712 12 0.165778 11.9103 0.0746751 11.7629C-0.0164282 11.6155 -0.0247102 11.4314 0.0527869 11.2764L4.05279 3.27644C4.15649 3.06903 4.38919 2.96015 4.61488 3.01342Z"
      fill={color}
    />
    <path
      d="M10.3851 3.01342C10.6108 2.96015 10.8435 3.06903 10.9472 3.27644L14.9472 11.2764C15.0247 11.4314 15.0164 11.6155 14.9253 11.7629C14.8342 11.9103 14.6733 12 14.5 12H10.5C10.2239 12 10 11.7762 10 11.5V3.50005C10 3.26816 10.1594 3.0667 10.3851 3.01342Z"
      fill={color}
    />
  {/if}
</svg>
