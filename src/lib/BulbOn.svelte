...
>
  {#if variation === 'outline'}
    ...
    />
  {:else}
    <path d="M7 0V2H8V0H7Z" fill={color} />
    <path
    ...
    <path
      ...
      fill={color}
    /> <path d="M0 8H2V7H0V8Z" fill={color} /> <path d="M13 8H15V7H13V8Z" fill={color} />
    <path d="M6 15H9V14H6V15Z" fill={color} />
  {/if}
</svg>
...
@prop export let ariaLabel = 'bulb on';
-->
