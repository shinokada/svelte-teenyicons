...
>
  {#if variation === 'outline'}
    <path d="M3.5 4.5L0.5 11.5H3.5L7.5 0.5L3.5 4.5Z" stroke={color} stroke-linejoin="round" />
    <path
      d="M14.5 13.5L9.5 2.5L7.5 7.5L10.5 11.5L4.5 13.5H14.5Z"
      stroke={color}
...
@prop export let ariaLabel = 'azure';
-->
