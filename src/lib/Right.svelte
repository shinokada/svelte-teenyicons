...
>
  {#if variation === 'outline'}
    <path d="M5 14L12 7.5L5 1" stroke={color} stroke-linecap="square" />
  {:else}
    <path d="M12 7.5L4 0V15L12 7.5Z" fill={color} />
  {/if}
</svg>
...
@prop export let ariaLabel = 'right';
-->
