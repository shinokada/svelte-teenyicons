...
>
  ...
  {:else}
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M0 2.5C0 1.67157 0.671573 1 1.5 1H9.5C10.3284 1 11 1.67157 11 2.5V3L13.5 3C14.3284 3 15 3.67157 15 4.5V12.5C15 13.3284 14.3284 14 13.5 14L1.5 14C0.671573 14 0 13.3284 0 12.5V2.5ZM9 10H12V9H9V10Z"
      fill={color}
    />
  {/if}
</svg>
