...
>
  {#if variation === 'outline'}
    <path
      d="M8 10.5V10H7V10.5H8ZM7 10.51V11.01H8V10.51H7ZM7 4V8H8V4H7ZM7 10.5V10.51H8V10.5H7Z"
      fill={color}
    />
  {:else}
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M7 8V4H8V8H7ZM8 10V11.01H7V10H8Z"
      fill={color}
    />
  {/if}
</svg>
...
@prop export let ariaLabel = 'exclamation small';
-->
