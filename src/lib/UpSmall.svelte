...
>
  {#if variation === 'outline'}
    <path d="M10.5 8.5L7.5 5.5L4.5 8.5" stroke={color} stroke-linecap="square" />
  {:else}
    <path d="M7.50008 4.79285L3.29297 8.99995H11.7072L7.50008 4.79285Z" fill={color} />
  {/if}
</svg>
...
@prop export let ariaLabel = 'up small';
-->
