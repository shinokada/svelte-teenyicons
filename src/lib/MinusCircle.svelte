...
>
  {#if variation === 'outline'}
    <path
      d="M4 7.5H11M7.5 14.5C3.63401 14.5 0.5 11.366 0.5 7.5C0.5 3.63401 3.63401 0.5 7.5 0.5C11.366 0.5 14.5 3.63401 14.5 7.5C14.5 11.366 11.366 14.5 7.5 14.5Z"
      stroke={color}
    />
  {:else}
    <path
...
@prop export let ariaLabel = 'minus circle';
-->
