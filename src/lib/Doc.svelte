<script lang="ts">
	...
	let svgsolid = `<path d="M3 10V7H3.5C3.77614 7 4 7.22386 4 7.5V9.5C4 9.77614 3.77614 10 3.5 10H3Z" fill="black"/> <path d="M7 7.5C7 7.22386 7.22386 7 7.5 7C7.77614 7 8 7.22386 8 7.5V9.5C8 9.77614 7.77614 10 7.5 10C7.22386 10 7 9.77614 7 9.5V7.5Z" fill="black"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M1 1.5C1 0.671573 1.67157 0 2.5 0H10.7071L14 3.29289V13.5C14 14.3284 13.3284 15 12.5 15H2.5C1.67157 15 1 14.3284 1 13.5V1.5ZM3.5 6H2V11H3.5C4.32843 11 5 10.3284 5 9.5V7.5C5 6.67157 4.32843 6 3.5 6ZM7.5 6C6.67157 6 6 6.67157 6 7.5V9.5C6 10.3284 6.67157 11 7.5 11C8.32843 11 9 10.3284 9 9.5V7.5C9 6.67157 8.32843 6 7.5 6ZM10 11V6H13V8H12V7H11V10H12V9H13V11H10Z" fill="black"/> `;
	switch (variation) {
		case 'outline':
			svgpath = svgoutline;
			break;
